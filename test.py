...
import time, board, busio, adafruit_vl53l0x, dual_VL53L0X

import numpy as np
from driver import Driver

print("Setup both sensors:")

# Initialize I2C bus and sensor.
# i2c = busio.I2C(board.SCL, board.SDA)
(vl530, vl531) = dual_VL53L0X.setup(24, 25)
...
print("printing range of sensors:")
# Main loop will read the range and print it every second.
while True:
    print("Range: {0}mm".format(vl530.range))
    print("Range: {0}mm".format(vl531.range))
    time.sleep(1.0)
